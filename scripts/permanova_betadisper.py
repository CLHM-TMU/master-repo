...
for qza_fp in distance_qzas:
    ...
    for col in meta.columns:
        ...
        for g1, g2 in combinations(groups, 2):
            ...
            # Need at least 2 samples per group for betadisper
...
# ------------------------------
# BH correction across pairwise p-values
# grouped by (distance, comparison, test)
# ------------------------------
...
def bh_adjust(p_values):
    ...
    # Enforce monotonicity by taking the cumulative minimum from the right
